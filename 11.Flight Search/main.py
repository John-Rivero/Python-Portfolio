...
from airport_info import retrieve_iata, retrieve_airportname
from city_image import *
from retrieveprice import *

airport_names = retrieve_airportname()

iata_codes = retrieve_iata()  
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.departure = QtWidgets.QDateEdit(parent=self.widget)
...
##############################################################       
        ...
        combined_items = [f'{airport_names}  ({iata_codes})' for airport_names, iata_codes in zip(airport_names, iata_codes)]
        self.locationFrom.addItem("Select your city.")
        self.locationFrom.addItems(combined_items)
...
##############################################################
        ...
        combined_items = [f'{airport_names}  ({iata_codes})' for airport_names, iata_codes in zip(airport_names, iata_codes)]
        self.locationTo.addItem("Select your city.")
        self.locationTo.addItems(combined_items)
...
##############################################################
        ...
        self.arriving = QtWidgets.QDateEdit(parent=self.widget)
...
"}")
        ...
        self.cityImage.setScaledContents(True)
...
#******************************************************************************************
        self.locationTo.currentIndexChanged.connect(lambda:image_city_Clicked(self,self))
        self.pushButton.clicked.connect(lambda:identifyPrice(self, self))
